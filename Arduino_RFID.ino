...
// Instance of the class for RTC using library DST RTC. 
RTC_DS1307 rtc;
...
//  pinMode(greenLED, OUTPUT);
  ...
  //setcursor seems to reset the screen or clearscreen
  lcd.setCursor(0, 1);
  lcd.print("Done...");
...
void logCard() {
  ...
  // Open file called tag list
  myFile=SD.open("RFIDtag.txt", FILE_WRITE);
